#!/usr/bin/env bash
# Automated Linux development environment setup with packages, tools, and configurations
# TODO: After this script, make sure to stow configs on demand using a cli-tool like gnu stow
